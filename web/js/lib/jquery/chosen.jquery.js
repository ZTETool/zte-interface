  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.input_blur = function(evt) {
      ...
      if (!this.mouse_on_container) {
        this.active_field = false;
        if (this.max_selected_options > this.choices && contentRegex.test(this.search_field.val())) {
...
//      this.f_width = this.form_field_jq.outerWidth();
      this.f_width = this.options.width.replace(/\D/g, '');//PX-867
      container_props = {
      ...
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" id="chosen-search-field-input" maxlength="40" data-trans="select_some_options" value="' + $.i18n.prop('select_some_options') + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>');
      } else {
        container_div.html('<a href="javascript:void(0)" class="chzn-single chzn-default"><span>' + $.i18n.prop('select_some_options') + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
      }
      ...
      if (this.result_highlight) {
        ...
        return this.search_field_scale();
          ...
          for(var i = 0; i < this.form_field.options.length; i++){
              if(this.form_field.options[i].value == getLast8Number(searchVal)){
          ...
          if(!isExist){
              if (this.max_selected_options >= this.choices){
                  this.form_field.add(new Option(searchVal, getLast8Number(searchVal), false, true));
              } else {
                  this.form_field.add(new Option(searchVal, getLast8Number(searchVal), false, false));
              }
          }
